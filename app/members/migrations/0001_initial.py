# Generated by Django 2.2.11 on 2020-04-04 13:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_users', models.ManyToManyField(related_name='send_me_like_users', through='members.SendLike', to='members.UserInfo')),
                ('star_users', models.ManyToManyField(related_name='send_me_star_users', through='members.SendStar', to='members.UserInfo')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
