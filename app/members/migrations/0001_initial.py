# Generated by Django 2.2.11 on 2020-04-04 08:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personality', models.CharField(blank=True, choices=[('지적인', '지적인'), ('차분한', '차분한'), ('유머있는', '유머있는'), ('낙천적인', '낙천적인'), ('내향적인', '내향적인'), ('외향적인', '외향적인'), ('감성적인', '감성적인'), ('상냥한', '상냥한'), ('귀여운', '귀여운'), ('섹시한', '섹시한'), ('4차원인', '4차원인'), ('발랄한', '발랄한'), ('도도한', '도도한')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('story', models.CharField(blank=True, choices=[('이상적인 첫 소개팅 장소', '이상적인 첫 소개팅 장소'), ('내 외모중 가장 마음에 드는 곳은', '내 외모중 가장 마음에 드는 곳은'), ('남들보다 이것 하나는 자신있어요', '남들보다 이것 하나는 자신있어요')], max_length=60)),
